<template>
  ...
  <div
    class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-800 z-30"
    id="main-nav"
  >
    <div class="w-full h-16 border-b border-gray-900 flex px-4 items-center mb-8">
